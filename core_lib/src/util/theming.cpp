 ...
 * Does not include the application default palette.
 *
...
ThemeColorPalette::ThemeColorPalette(const QPalette& palette, const QString& displayName)
{
    setPalette(palette);
    setDisplayName(displayName);
}

void ThemeColorPalette::setPalette(const QPalette& palette)
{
    m_palette = palette;
    m_valid = true;
}
...
QString ThemeColorPalette::id() const
{
    ...
    return fileInfo.baseName().prepend(isFromUser() ? "user-" : "builtin-");
}

void ThemeColorPalette::setDisplayName(const QString& displayName)
{
